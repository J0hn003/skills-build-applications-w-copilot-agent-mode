...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create workouts
        w1 = Workout.objects.create(name='Full Body Workout', description='A workout for all major muscle groups')
        w2 = Workout.objects.create(name='Cardio Blast', description='High intensity cardio workout')
